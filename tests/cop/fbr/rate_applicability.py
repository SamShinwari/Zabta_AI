...
class FBRRateApplicabilityResolver:
    ...
    def resolve(
        ...
        if standard_candidates:
            ...
            # ------------------------------------------------
            # Standard/base candidate ranking
            #
            # Legal chronology takes priority:
            #
            #   1. Date relevance
            #   2. Latest effective_from
            #   3. Year
            #   4. Confidence / retrieval score
            #
            # This prevents a highly-scored old document from
            # outranking a newer applicable FBR document.
            # ------------------------------------------------
            ...
            def standard_rank(
                ...
                # Date relevance
                #
                # Future documents must never outrank an
                # applicable document.
                # ------------------------------------------------
            ...
            return ApplicableTaxRate(
                ...
                explanation=(
                    ...
                    "the base sales-tax rate using legal "
                    "chronology. Applicable/current evidence "
                    "was prioritized by date relevance, "
                    "effective date, year, and then confidence. "
                    "Any further tax candidate is kept "
                    "separately and is not treated as the "
                    "base rate."
                ),
            )
